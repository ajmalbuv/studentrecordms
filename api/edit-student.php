										...
										<div class="row">
											<div class="col-lg-10">
												<div class="form-group">
													...
													<div class="col-lg-6">
														<input class="form-control" name="regno" id="regno"
												...
												<div class="form-group">
													...
													<div class="col-lg-6">
														<select class="form-control" name="course-short" id="cshort"
															...
															<option VALUE="<?php echo $cid = $res['cid'] ?>">
																<?php echo $res['cshort']; ?>
															</option>
															...
															while ($res2 = mysqli_fetch_array($sql)) {
																if ($res2['cid'] == $c) {
																	...
																	?>
																	<option VALUE="<?php echo htmlentities($res2['cid']); ?>">
																		<?php echo htmlentities($res2['cshort'] . "-" . $res2['cfull']) ?>
																	</option>
																<?php }
															} ?>
														</select>
												...
												<div class="form-group">
													...
													<div class="col-lg-6">
														...
														<input class="form-control" name="session"
															value="<?php echo htmlentities($res['session']); ?>" readonly>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-lg-4">
															<input class="form-control" name="fname"
																value="<?php echo htmlentities($res['fname']); ?>"
																required="required">
														</div>
														<div class="col-lg-2">
														...
														<div class="col-lg-4">
															<input class="form-control" name="mname"
																value="<?php echo htmlentities($res['mname']); ?>">
														</div>
													</div>
													<br><br>
													...
													<div class="form-group">
														...
														<div class="col-lg-4">
															<input class="form-control" name="lname"
																value="<?php echo htmlentities($res['lname']); ?>">
														</div>
														<div class="col-lg-2">
															<label>Gender<span id=""
																	style="font-size:11px;color:red">*</span></label>
														...
														<div class="col-lg-4">
															...
															if (strcasecmp($res['gender'], "Male") == 0) { ?>
																<input type="radio" name="gender" id="male" value="Male"
																	required="required" checked> &nbsp; Male &nbsp;
															<?php } else { ?>
																<input type="radio" name="gender" id="male" value="Male"
													...
													<div class="form-group">
														...
														<div class="col-lg-4">
															<input class="form-control" name="ocp" id="ocp"
																value="<?php echo htmlentities($res['ocp']); ?>">
														</div>
													</div>
													<br><br>
													...
													<div class="form-group">
														...
														<div class="col-lg-4">
															<select class="form-control" name="income" id="income"
																required="required">
																<option value="<?php echo htmlentities($res['income']); ?>">
																	<?php echo htmlentities($res['income']); ?>
																</option>
														...
														<div class="col-lg-4">
															<select class="form-control" name="category" id="category"
																required="required">
																<option value="<?php echo htmlentities($res['category']); ?>">
																	<?php echo htmlentities($res['category']); ?>
																</option>
													...
													<div class="form-group">
														...
														<div class="col-lg-4">
															<select class="form-control" name="ph" id="ph" required="required">
																<option VALUE="<?php echo htmlentities($res['pchal']); ?>">
																	<?php echo htmlentities($res['pchal']); ?>
																</option>
												...
												<div class="panel-body">
													<div class="row">
														<div class="col-lg-12">
															...
															<div class="form-group">
																<div class="col-lg-2">
																	<label>Country<span id=""
																			style="font-size:11px;color:red">*</span></label>
																</div>
																<div class="col-lg-4">
																	<select class="form-control" name="country" id="country"
																		onchange="showState(this.value)" required="required"
																		value="<?php echo htmlentities($res['country']); ?>">
																		<option
																			VALUE="<?php echo htmlentities($res['country']); ?>">
																			<?php echo htmlentities($res['name']) ?>
																		</option>
																		...
																		while ($res3 = mysqli_fetch_array($ret)) {
																			...
																			<option
																				VALUE="<?php echo htmlentities($res3['id']); ?>">
																				<?php echo htmlentities($res3['name']) ?>
																			</option>
																...
																<div class="col-lg-4">
																	<select name="state" id="state" class="form-control"
																		...
																		<option
																			VALUE="<?php echo htmlentities($res['sid']); ?>">
																			<?php echo htmlentities($res['sname']) ?>
																		</option>
																	</select>
																</div>
															...
															<div class="form-group">
																...
																<div class="col-lg-4">
																	<select name="city" id="dist" class="form-control"
																		onchange="showDist(this.value)">
																		<option
																			VALUE="<?php echo htmlentities($res['dist']); ?>">
																			<?php echo htmlentities($res['dist']) ?>
																		</option>
																	</select>
																</div>
																<div class="col-lg-2">
																...
																<div class="col-lg-4">
																	<textarea class="form-control" rows="3"
																		name="padd"><?php echo htmlentities($res['padd']); ?></textarea>
																</div>
															</div>
															<br><br><br><br>
															...
															<div class="form-group">
																...
																<div class="col-lg-4">
																	<textarea class="form-control" rows="3"
																		name="cadd"><?php echo htmlentities($res['cadd']); ?></textarea>
																</div>
																<div class="col-lg-2">
																								...
																								<td>
																									<div class="col-lg-6">
																										<input
																											...
																											type="text"
																											name="board1"
																											value="<?php echo htmlentities($res['board']); ?>">
																									</div>
																								</td>
																								<td>
																									<div class="col-lg-6">
																										<input
																											...
																											type="text"
																											name="roll1"
																											value="<?php echo htmlentities($res['roll']); ?>">
																									</div>
																								</td>
																								<td>
																									<div class="col-lg-6">
																										<input
																											...
																											type="text"
																											name="pyear1"
																											value="<?php echo htmlentities($res['pyear']); ?>">
																									</div>
																								</td>
																							</tr>
																								...
																								<td>
																									<div class="col-lg-6">
																										<input
																											...
																											type="text"
																											name="board2"
																											value="<?php echo htmlentities($res['board1']); ?>">
																									</div>
																								</td>
																								<td>
																									<div class="col-lg-6">
																										<input
																											...
																											type="text"
																											name="roll2"
																											value="<?php echo htmlentities($res['roll1']); ?>">
																									</div>
																								</td>
																								<td>
																									<div class="col-lg-6">
																										<input
																											...
																											type="text"
																											name="pyear2"
																											value="<?php echo htmlentities($res['yop1']); ?>">
																									</div>
																								</td>
																							</tr>
																								...
																								<td>
																									<div class="col-lg-6">
																										<input
																											...
																											type="text"
																											name="sub1"
																											value="<?php echo htmlentities($res['sub']); ?>">
																									</div>
																								</td>
																								<td>
																									<div class="col-lg-6">
																										<input
																											...
																											type="text"
																											name="marks1"
																											value="<?php echo htmlentities($res['marks']); ?>">
																									</div>
																								</td>
																								<td>
																									<div class="col-lg-6">
																										<input
																											...
																											type="text"
																											name="fmarks1"
																											value="<?php echo htmlentities($res['fmarks']); ?>">
																									</div>
																								</td>
																							</tr>
																								...
																								<td>
																									<div class="col-lg-6">
																										<input
																											...
																											type="text"
																											name="sub2"
																											value="<?php echo htmlentities($res['sub1']); ?>">
																									</div>
																								</td>
																								<td>
																									<div class="col-lg-6">
																										<input
																											...
																											type="text"
																											name="marks2"
																											value="<?php echo htmlentities($res['marks1']); ?>">
																									</div>
																								</td>
																								<td>
																									<div class="col-lg-6">
																										<input
																											...
																											type="text"
																											name="fmarks2"
																											value="<?php echo htmlentities($res['fmarks1']); ?>">
																									</div>
																								</td>
																							</tr>
															...
															<div class="form-group">
																...
																<div class="col-lg-6"><br><br>
																	<input type="submit" class="btn btn-primary"
																		name="submit" value="Update"></button>
																</div>
															</div>
														</div>
													</div><!--row!-->
