                                            ...
                                            <tbody>
                                                ...
                                                while ($res = mysqli_fetch_array($query)) {
                                                    ...
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td><?php echo htmlentities(strtoupper($res['fname'] . " " . $res['mname'] . " " . $res['lname'])); ?>
                                                        </td>
                                                        ...
                                                        <td width="100"><a
                                                                href="edit-student.php?id=<?php echo htmlentities($res['id']); ?>"
                                                                class="btn btn-primary btn-xs">Edit</a> &nbsp;&nbsp;
                                                            <a href="manage-students.php?del=<?php echo htmlentities($res['id']); ?>"
