										...
										<div class="row">
											<div class="col-lg-10">
												...
												<div class="form-group">
													...
													<div class="col-lg-6">
														<input class="form-control" name="adminname" id="adminname"
															value="<?php echo $res['FullName']; ?>" required="required">
													</div>
												</div> <br><br>
												...
												<div class="form-group">
													...
													<div class="col-lg-6">
														<input class="form-control" name="aemailid" id="aemailid"
															value="<?php echo $res['AdminEmail']; ?>" required="required">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-lg-6">
														<input class="form-control" name="loginid" id="loginid"
															value="<?php echo $res['loginid']; ?>" disabled required="required">
											...
											<div class="form-group">
												...
												<div class="col-lg-6"><br><br><input type="submit" class="btn btn-primary"
														name="submit" value="Update Profile"></button></div>
											</div>
										</div>
									</div>
