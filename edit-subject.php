								...
								while ($res = mysqli_fetch_array($query)) { ?>
									...
									<div class="panel-body">
										<div class="row">
											<div class="col-lg-10">
												...
												<div class="form-group">
													...
													<div class="col-lg-6">
														<input class="form-control" name="sub1" id="sub1"
															value="<?php echo $res['sub1']; ?>" required="required">
													</div>
												</div> <br><br>
												...
												<div class="form-group">
													...
													<div class="col-lg-6">
														<input class="form-control" name="sub2" id="sub2"
															value="<?php echo $res['sub2']; ?>" required="required">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-lg-6">
														<input class="form-control" name="sub3" id="sub3"
															value="<?php echo $res['sub3']; ?>" required="required">
													</div>
												</div> <br><br>
												...
												<div class="form-group">
													...
													<div class="col-lg-6">
														<input class="form-control" name="sub4" id="sub4"
															value="<?php echo $res['sub4']; ?>" required="required">
													</div>
												</div> <br><br>
										...
										<div class="form-group">
											...
											<div class="col-lg-6"><br><br><input type="submit" class="btn btn-primary"
													name="submit" value="Update Course"></button></div>
										</div>
									</div>
								</div>
